import type { BlogPost, Credential, GalleryItem } from './types'
...
class MemStorage {
  ...
  private seedData() {
    ...
    const edu2: Credential = {
      ...
      date: "2013 - 2018",
      description: "Activities and societies: Involved in UBC Recreation as an Assistant Director. Involved in JDC West as a participant and coach.",
    }
    ...
    const edu3: Credential = {
      ...
      date: "2016 - 2016",
      description: "• Received the NUS Lee Foundation Award worth $2,500 for academic and extra-curricular achievement.",
    }
  ...
  // Blog Posts
  getAllBlogPosts(type?: string): BlogPost[] {
